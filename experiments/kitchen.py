...
from datasets import kitchen
from utils.viz import show_frame
from utils.metrics import rect_iou, center_error

class ExperimentKitchen(object):
    def __init__(self, root_dir, version=2020, result_dir='results', report_dir='reports'):
        super(ExperimentKitchen, self).__init__()
        self.dataset = kitchen(root_dir, version)
        self.result_dir = os.path.join(result_dir, 'kitchen' + str(version))
        self.report_dir = os.path.join(report_dir, 'kitchen' + str(version))
